...
const deliverables = ["Medición técnica in situ y verificación de planos", "Planificación por hitos (Gantt) y coordinación de oficios", "Transporte, accesos y manipulación en obra", "Instalación de mobiliario, corpóreas, rótulos y gran formato", "Conexión y pruebas de iluminación/eléctrica (si aplica)", "Acabado fino, limpieza y entrega con checklist", "Mantenimiento correctivo y preventivo"];
const differentials = [{
  ...
  description: "Planificación clara, comunicación continua y cierre con checklist de calidad."
}, {
  title: "Un solo interlocutor",
  description: "Coordinación integral con diseño, fabricación y proveedores del cliente."
}];
const faqs = [{
...
const ServicioInstalacion = () => {
  return <main className="pt-24">
      ...
      <section className="section-padding bg-muted">
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <img src={instalacionImg1} alt="Equipo profesional instalando mobiliario comercial" className="w-full h-[400px] object-cover rounded-lg shadow-elegant" />
            <img src={instalacionImg2} alt="Proceso de montaje coordinado en espacio comercial" className="w-full h-[400px] object-cover rounded-lg shadow-elegant" />
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-muted">
        <div className="container-custom max-w-3xl">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => <div key={index} className="border-b pb-6">
      ...
      <CTAStrip title="¿Listo para instalar?" secondaryCTA={{
